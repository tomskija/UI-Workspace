...
const WeatherDashboard: React.FC<WeatherDashboardProps> = ({ 
  ...
  const { data: healthCheck } = useQuery(weatherQueries.health());
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-xl p-8 max-w-md mx-4">
          ...
          <p className="text-gray-600 text-center mb-4">
            Unable to connect to the Weather-Forecasting backend. Please check if the service is running on the configured port.
          </p>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-white mb-1">Weather Forecasting</h2>
      ...
      {alerts && alerts.length > 0 && (
        <div className="bg-red-500/20 backdrop-blur-md border border-red-300/30 rounded-xl p-4">
          <div className="flex items-center mb-3">
            <AlertTriangle className="w-5 h-5 text-red-300 mr-2" />
            <h3 className="text-red-200 font-semibold">Weather Alerts</h3>
          </div>
          {alerts.map((alert) => (
            <div key={alert.id} className="mb-2 last:mb-0">
              <p className="text-red-200 font-medium">{alert.title}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* Temperature Chart */}
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6">
          <h4 className="text-xl font-bold text-white mb-4">7-Day Trend</h4>
          {forecastLoading ? (
      ...
      {/* Weekly Forecast */}
      <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6">
        <h4 className="text-xl font-bold text-white mb-6">Weekly Forecast</h4>
        {forecastLoading ? (
